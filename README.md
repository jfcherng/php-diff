[![Build Status](https://travis-ci.org/jfcherng/php-diff.svg?branch=v5)](https://travis-ci.org/jfcherng/php-diff)
...
See [example/demo.php](https://github.com/jfcherng/php-diff/blob/v5/example/demo.php) and files under `tests/`.
