 ...
 */
final class Inline extends AbstractHtmlRenderer
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return
            '<tbody class="change change-' . self::OP_CLASS_MAP[$block['op']] . '">' . (
                match ($block['op']) {
    ...
    protected function renderTableRow(
        ...
        return
            '<tr data-type="' . self::SYMBOL_MAP[$op] . '">' .
                ...
                '<th class="sign ' . self::OP_CLASS_MAP[$op] . '">' . self::SYMBOL_MAP[$op] . '</th>' .
