...
final class WordTest extends TestCase
{
    ...
    public function testRenderWordGlues1(): void
    {
        ...
        self::assertSame('good-<del>looking-x</del>', $oldDiff);
        self::assertSame('good-<ins>-y</ins>', $newDiff);
    }
